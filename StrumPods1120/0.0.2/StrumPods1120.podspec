#
#  Be sure to run `pod spec lint StrumPods1120.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "A short description of StrumPods1120."

  s.homepage     = "https://github.com/StrumElin/MyCocoapods.git"
